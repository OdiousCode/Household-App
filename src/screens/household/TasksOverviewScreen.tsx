...
export default function TaskOverviewScreen({
  ...
  return (
    <>
      {activeProfile?.role === "Admin" ? ( // If the user is an admin, the following is displayed
        <SafeAreaView style={styles.container}>
          <View style={{ height: 500, width: "90%" }}>
            <Text
              style={{ fontSize: 20, fontWeight: "bold", marginBottom: 30 }}
            >
              Hej {activeProfile?.name} [Ägare]
            </Text>
        ...
        // If user is not an admin, the following is rendered.
        <SafeAreaView style={styles.container}>
          <View style={{ height: 500, width: "90%" }}>
            <Text
              style={{ fontSize: 20, fontWeight: "bold", marginBottom: 30 }}
