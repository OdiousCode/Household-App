...
Om du har VSCode installerat, kan du använda terminalen i VSCode. Annars går det att göra direkt ifrån operativsystemets terminal.
När du klonat ned vår app ifrån github, navigera till den i terminalen eller öppna i vscode.

1 - Först behöver du installera nodeJS - länk: https://nodejs.org/en/download/

2 - Skriv npm install i terminalen för att installera alla nödvändiga packages vår applikation använder.

3 - Skriv npm start i terminalen för att köra projektet 

4 - Ladda ned expo-go ifrån playstore eller appstore på din telefon.

5 - Öppna terminalen i VSCode, tryck C - Scanna QR-koden i konsollen med expo-go appen i telefonen.
*  Eller om du faktiskt får android studio att fungera , tryck A för att öppna på android-emulator, I - för ios-emulator.

6 - Sedan bör appen vara igång, skapa ett konto och testa!
* user: Gorgen@test.com password: Qwe123 är ett färdigt konto som har två profiler, lite data och statistik.

*Värt att notera, vi har ej fått android-studio emulator att fungera så bra, utan har använt oss av fysiska telefoner för testning.

# Avgränsningar

Vi valde att ha ikoner på toptab-navigatorn(hushålls-skärmarna) istället för pilar, blev lätt att se vart man var och vad man hade för access (skillnad på admin/ägare och vanlig användare)

En avslutad syssla visar enbart den som gjorde den senast direkt i sysslo-vyn, men visar all historik i statisken istället.

## Uppgiftsbeskrivning ##

I det här projektet skapar vi en nativ hushållsapp med hjälp av React-Native (RN), Expo och Typescript. Nedan följer information om applikationen inklusive en kravlista över det som vi har gjort.
...
## Kravlista vi har anser att vi uppfyllt:
